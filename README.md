...
* **Yang** ($\text{—}$) is active, dynamic solar energy; it is restless and burns out quickly, transforming three times more readily into Yin.
* **Yin** ($\text{– –}$) is receptive, steady lunar/earthen energy; it is quiet and slow to alter course.
...
| :--- | :---: | :--- | :---: | :---: | :---: | :---: |
| **Young Yin (8)** | $\text{– –}$ | Unchanging Yin | $43.75\%$ (14/32) | **$44.84\%$** | **$44.74\%$** (17/38) | **$< 0.10\%$** |
| **Young Yang (7)** | $\text{—}$ | Unchanging Yang | $31.25\%$ (10/32) | **$28.87\%$** | **$28.95\%$** (11/38) | **$< 0.08\%$** |
| **Old Yang (9)** | $\text{—}\ \mathbf{\circ}$ | Changing Yang $\rightarrow$ Yin | $18.75\%$ (6/32) | **$21.12\%$** | **$21.05\%$** (8/38) | **$< 0.07\%$** |
| **Old Yin (6)** | $\text{– –}\ \mathbf{\times}$ | Changing Yin $\rightarrow$ Yang | $6.25\%$ (2/32) | **$5.17\%$** | **$5.26\%$** (2/38) | **$< 0.09\%$** |
...
- **Segmented 3-Phase Navigation**:
  - **☯ Chamber**: Step-by-step bottom-up line casting (Line 1 Earth $\rightarrow$ Line 6 Heaven) with lower and upper trigram illumination.
